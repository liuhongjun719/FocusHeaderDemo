...
/*
 double ceil(double a);取最小整数，返回浮点数整数部分（舍弃小数点部分，往个位数进1）
...
- (void)viewDidLoad {
    ...
    NSMutableArray * array2 = [@[@"推荐",@"热点",@"汽车",@"财经频道",@"热点",@"社会",@"明星八卦",@"IT科技",@"移动互联网",@"金融",@"大数据",@"股票期货",@"食品安全新闻食品食品安全fdsfdsfdsfdsfdsfdsfdsfdsfsd"]mutableCopy];
